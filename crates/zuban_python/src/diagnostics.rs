...
use parsa_python_cst::{CodeIndex, NodeIndex, Tree, TypeIgnoreComment};
...
pub(crate) enum IssueKind {
    ...
    ClassPatternHasNoAttribute { class: Box<str>, attribute: Box<str> },
...
impl<'db> Diagnostic<'db> {
    ...
    pub(crate) fn message_with_notes(&self, additional_notes: &mut Vec<String>) -> String {
        ...
        match &self.issue.kind {
            ...
            SelfTypeInStaticMethod => "Static methods cannot use Self type".to_string(),
            ...
            NamedTupleOverwriteInSubclass => "NamedTuple attributes cannot be overridden in subclasses".to_string(),
